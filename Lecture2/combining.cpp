...
struct Data
{
    ...
    static constexpr float scale_increment{0.01f};
...
GLuint Data::uniform_transform_matrix_id{};
...
void main()
{
    gl_Position = transform_matrix * vec4(pos.x, pos.y, pos.z, 1.0);
}
)";
...
void create_shaders_program()
{
    ...
    Data::uniform_transform_matrix_id = glGetUniformLocation(Data::shaders_id, "transform_matrix");
}
...
int main()
{
    ...
    GLFWwindow* main_window = glfwCreateWindow(WIDTH, HEIGHT, "Combining", nullptr, nullptr);
