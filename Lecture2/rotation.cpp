...
struct Data
{
    ...
    static GLuint uniform_rotation_matrix_id;

    static const std::string vertex_shader;
    static const std::string fragment_shader;

    static constexpr float angle_increment{0.5f};
};

GLuint Data::VAO_id{};
GLuint Data::VBO_id{};
GLuint Data::shaders_id{};
GLuint Data::uniform_rotation_matrix_id{};
...
void main()
{
    gl_Position = rotation_matrix * vec4(0.3 * pos.x, 0.3 * pos.y, pos.z, 1.0);
}
)";
...
void create_shaders_program() noexcept
{
    ...
    Data::uniform_rotation_matrix_id = glGetUniformLocation(Data::shaders_id, "rotation_matrix");
}
...
int main()
{
    ...
    GLFWwindow* main_window = glfwCreateWindow(WIDTH, HEIGHT, "Rotation", nullptr, nullptr);
    ...
    while (!glfwWindowShouldClose(main_window))
    {
        ...
        rotation_matrix = glm::rotate(rotation_matrix, to_radian(current_angle), glm::vec3{0.f, 0.f, 1.f});

        glUniformMatrix4fv(Data::uniform_rotation_matrix_id, 1, GL_FALSE, glm::value_ptr(rotation_matrix));
