...
struct Data
{
    ...
    static GLuint uniform_x_move_id;

    static const std::string vertex_shader;
    static const std::string fragment_shader;

    static constexpr float triangle_max_offset{0.7f};
    static constexpr float x_move_increment{0.005f};
};

GLuint Data::VAO_id{};
GLuint Data::VBO_id{};
GLuint Data::shaders_id{};
GLuint Data::uniform_x_move_id{};
...
void main()
{
    gl_Position = vec4(0.3 * pos.x + x_move, 0.3 * pos.y, pos.z, 1.0);
}
)";
...
void create_shaders_program() noexcept
{
    ...
    Data::uniform_x_move_id = glGetUniformLocation(Data::shaders_id, "x_move");
}
...
int main()
{
    ...
    GLFWwindow* main_window = glfwCreateWindow(WIDTH, HEIGHT, "Uniform Variables", nullptr, nullptr);
    ...
    while (!glfwWindowShouldClose(main_window))
    {
        ...
        if (moving_to_right)
        {
            current_triangle_offset += Data::x_move_increment;
        }
        else
        {
            current_triangle_offset -= Data::x_move_increment;
        ...
        glUniform1f(Data::uniform_x_move_id, current_triangle_offset);
