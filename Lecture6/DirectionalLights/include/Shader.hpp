...
public:
    ...
    GLuint get_ambient_intensity_id() const noexcept { return uniform_directional_light.uniform_ambient_intensity_id; }

    GLuint get_ambient_color_id() const noexcept { return uniform_directional_light.uniform_color_id; }

    GLuint get_uniform_diffuse_intensity_id() const noexcept { return uniform_directional_light.uniform_diffuse_intensity_id; }

    GLuint get_uniform_direction_diffuse_id() const noexcept { return uniform_directional_light.uniform_direction_id; }
    ...
    void set_directional_light(const DirectionalLight& light) const noexcept;
