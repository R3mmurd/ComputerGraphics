...
{
    light.use(get_ambient_intensity_id(), get_ambient_color_id(), get_uniform_diffuse_intensity_id(), get_uniform_direction_diffuse_id());
}
...
void Shader::create_program(std::string_view vertex_shader_code, std::string_view fragment_shader_code) noexcept
{
    ...
    uniform_directional_light.uniform_ambient_intensity_id = glGetUniformLocation(program_id, "directional_light.ambient_intensity");
    uniform_directional_light.uniform_color_id = glGetUniformLocation(program_id, "directional_light.color");
    uniform_directional_light.uniform_diffuse_intensity_id = glGetUniformLocation(program_id, "directional_light.diffuse_intensity");
