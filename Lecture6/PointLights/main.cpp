...
int main()
{
    ...
    auto main_window = Window::create(WIDTH, HEIGHT, "Point Lights");
    ...
    point_lights.push_back(PointLight{0.f, 0.f, 1.f, 0.1f, 0.4f, 4.f, 0.f, 0.f, 0.1f, 0.2f, 0.3f});
    point_lights.push_back(PointLight{0.f, 1.f, 0.f, 0.f, 1.f, -4.f, 2.f, 0.f, 0.1f, 0.1f, 0.3f});
