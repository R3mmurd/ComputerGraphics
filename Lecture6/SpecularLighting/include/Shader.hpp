...
public:
    ...
    GLuint get_uniform_diffuse_intensity_id() const noexcept { return uniform_diffuse_intensity_id; }

    GLuint get_uniform_direction_diffuse_id() const noexcept { return uniform_direction_id; }
...
private:
    ...
    GLuint uniform_diffuse_intensity_id{0};
    GLuint uniform_direction_id{0};
