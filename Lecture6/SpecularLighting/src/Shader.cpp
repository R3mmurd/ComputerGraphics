...
void Shader::create_program(std::string_view vertex_shader_code, std::string_view fragment_shader_code) noexcept
{
    ...
    uniform_ambient_intensity_id = glGetUniformLocation(program_id, "directional_light.ambient_intensity");
    uniform_color_id = glGetUniformLocation(program_id, "directional_light.color");
    uniform_diffuse_intensity_id = glGetUniformLocation(program_id, "directional_light.diffuse_intensity");
    uniform_direction_id = glGetUniformLocation(program_id, "directional_light.direction");
...
void Shader::clear() noexcept
{
    ...
    uniform_ambient_intensity_id = 0;
    uniform_color_id = 0; 
    uniform_diffuse_intensity_id = 0;
    uniform_direction_id = 0;
