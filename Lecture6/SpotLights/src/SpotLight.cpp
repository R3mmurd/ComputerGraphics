...
SpotLight::SpotLight(GLfloat red, GLfloat green, GLfloat blue, GLfloat _ambient_intensity, GLfloat _diffuse_intensity,
    ...
    : PointLight{red, green, blue, _ambient_intensity, _diffuse_intensity, pos_x, pos_y, pos_z, _a, _b, _c},
