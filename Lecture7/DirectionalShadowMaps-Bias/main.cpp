...
void render_scene() noexcept
{
    ...
    model = glm::mat4{1.f};
    model = glm::translate(model, glm::vec3{-9.f, 3.f, 10.f});
...
void render_pass(const glm::mat4& projection, const glm::mat4& view) noexcept
{
    ...
    Data::shader_list[0]->set_point_lights(Data::point_lights);
    Data::shader_list[0]->set_spot_lights(Data::spot_lights);
    Data::shader_list[0]->set_directional_light_space_transform(Data::main_light->get_light_transform());

    Data::main_light->get_shadow_map()->read(GL_TEXTURE1);
    Data::shader_list[0]->set_texture(0);
    Data::shader_list[0]->set_directional_shadow_map(1);
...
int main()
{
    ...
    auto main_window = Window::create(Data::WIDTH, Data::HEIGHT, "Directional Shadow Maps");
    ...
    glm::mat4 projection = glm::perspective(glm::radians(45.f), main_window->get_aspect_ratio(), 0.1f, 100.f);
