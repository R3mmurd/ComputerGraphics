...
PointLight::PointLight(GLuint shadow_width, GLuint shadow_height,
    ...
    : Light{shadow_width, shadow_height, red, green, blue, _ambient_intensity, _diffuse_intensity}, position{pos_x, pos_y, pos_z}, a{_a}, b{_b}, c{_c}
{
...
glm::mat4 PointLight::get_light_transform() const noexcept
{
    return glm::mat4{};
}