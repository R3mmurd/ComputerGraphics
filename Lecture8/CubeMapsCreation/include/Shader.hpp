...
public:
    ...
    void set_point_lights(const std::vector<std::shared_ptr<PointLight>>& lights) const noexcept;

    void set_spot_lights(const std::vector<std::shared_ptr<SpotLight>>& lights) const noexcept;
