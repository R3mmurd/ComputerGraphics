...
void Shader::set_point_lights(const std::vector<std::shared_ptr<PointLight>>& lights) const noexcept
{
...
void Shader::set_spot_lights(const std::vector<std::shared_ptr<SpotLight>>& lights) const noexcept
{
